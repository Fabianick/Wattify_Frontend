import { ListarComprobanteComponent } from './components/comprobante-pago/listar-comprobante/listar-comprobante.component';
...
const routes: Routes = [
  ...
  },
  {
    path: 'comprobante-pago',component: ComprobantePagoComponent,children: [ //cambio de rutas
      { path: 'listar', component: ListarComprobanteComponent}, //listar
    ],
  }
